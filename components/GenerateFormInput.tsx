...
//   useEffect(() => {
//     if (state.success && state.formId) {
//       toast.success(state.message); // ✅ Green tick toast
//       setDescription(""); // input clear
//       // router.push(`/dashboard/forms/edit/${state.formId}`); // manual redirect disabled
  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center gap-4 my-8">
      ...
      {canGenerate ? (
        ...
        <Button disabled className="h-12 flex items-center gap-2 bg-gray-400 cursor-not-allowed hover:bg-gray-400">
          <Lock />
          Upgrade Plan
        </Button>
      )}
