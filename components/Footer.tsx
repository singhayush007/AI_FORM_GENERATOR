      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            Create AI-driven forms effortlessly and streamline your workflow with smart automation tools.
          </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <button
              type="submit"
              className="flex-shrink-0 px-4 sm:px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:opacity-90 transition duration-300"
            >
              Subscribe
            </button>
          </form>
